<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GridViewDemo.aspx.cs" Inherits="MvcEntityDemo1.GridViewDemo" %>
...
<body>  
  ...
  <fieldset>  
    <legend style="font-family: Arial Black;background-color:yellow; color:red; font-size:larger;font-style: oblique">Umesh's Real-Time Project</legend>  
                <table align="center">  
                    <tr>  
                        <td colspan="3" align="center" class="auto-style1">  
                            <strong style="background-color: Yellow;color: Blue; text-align: center; font-style: oblique">Umesh's Real-Time GridView CRUD Using Stored Procedure In Asp.Net</strong>  
                        </td>  
                    </tr>  
                    <tr>  
