...
using storedProcedurePractice.Models;

namespace storedProcedurePractice.Controllers
{
    public class Class1Controller : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Name,ReleaseDate,Category")] Class1 class1)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Name,ReleaseDate,Category")] Class1 class1)
        {
            if (ModelState.IsValid)
            {
